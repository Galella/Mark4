...
class UpdateOutletRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return ($user->isSuperAdmin()) || 
               ($user->isAdminWilayah()) || 
               ($user->isAdminArea() && $user->office_id == $this->outlet->office_id);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'code' => ['required', 'string', 'max:255', 'unique:outlets,code,' . $this->outlet->id],
            'outlet_type_id' => ['required', 'exists:outlet_types,id'],
            'office_id' => ['nullable', 'exists:offices,id'], // office_id can be updated for some roles
