        ...
        <div class="card-body border-bottom">
            <form method="GET" action="{{ route('users.index') }}" class="form-inline">
                <div class="form-group mb-2 mr-2">
                    ...
                    <input type="text" class="form-control" id="search" name="search" placeholder="Search users..." value="{{ request('search') }}">
                </div>
                <div class="form-group mb-2 mr-2">
                    <select name="role" id="role" class="form-control">
                        <option value="">All Roles</option>
                        <option value="admin_wilayah" {{ request('role') === 'admin_wilayah' ? 'selected' : '' }}>Admin Wilayah</option>
                        <option value="admin_area" {{ request('role') === 'admin_area' ? 'selected' : '' }}>Admin Area</option>
                        <option value="admin_outlet" {{ request('role') === 'admin_outlet' ? 'selected' : '' }}>Admin Outlet</option>
                    </select>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Please note:</p>
                    <ul>
                        <li>All related data and activities will be preserved with this user as reference</li>
