...
@section('title', 'Create Moda')

@section('content-header', 'Create New Moda')
        ...
        <div class="col-md-8">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Create New Moda</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('modas.store') }}">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="name">Name</label>
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter moda name" value="{{ old('name') }}" required>
                            @error('name')
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">Create Moda</button>
