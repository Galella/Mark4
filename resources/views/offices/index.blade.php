        ...
        <div class="card-body border-bottom">
            <form method="GET" action="{{ route('offices.index') }}" class="form-inline">
                <div class="form-group mb-2 mr-2">
                    ...
                    <input type="text" class="form-control" id="search" name="search" placeholder="Search offices..." value="{{ request('search') }}">
                </div>
                <div class="form-group mb-2 mr-2">
                    <select name="type" id="type" class="form-control">
                        <option value="">All Types</option>
                        <option value="pusat" {{ request('type') === 'pusat' ? 'selected' : '' }}>Kantor Pusat</option>
                        <option value="wilayah" {{ request('type') === 'wilayah' ? 'selected' : '' }}>Kantor Wilayah</option>
        ...
        <div class="card-body">
                    ...
                    <tbody>
                        @forelse($offices as $index => $office)
                            <tr>
                                ...
                                <td>{{ $office->code }}</td>
                                <td>
                                    <span class="badge badge-{{ $office->type === 'pusat' ? 'primary' : ($office->type === 'wilayah' ? 'info' : 'success') }}">
                                        {{ ucfirst($office->type) }}
                                    </span>
                                </td>
            ...
            <div class="mt-4 d-flex justify-content-between align-items-center">
                ...
                <ul class="pagination pagination-sm m-0 float-right">
                    ...
                    @else
                        <li class="page-item"><a class="page-link" href="{{ $offices->previousPageUrl() }}">&laquo;</a></li>
                    @endif
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger">This action cannot be undone and will permanently remove the office from the system.</p>
                    <p>Please note:</p>
                    <ul>
